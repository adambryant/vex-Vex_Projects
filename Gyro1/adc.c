...
*
*				Copyright ©2005-2010 R. Kevin Watson. All rights are reserved.
*
********************************************************************************
*
*	CHANGE LOG:
...
*					of user_code.c then call Initialize_ADC() in
*					user_code.c/User_Initialization().
*
*******************************************************************************/
void Initialize_ADC(void)  
{
	...
	// Set the number of available ADC channels. The VCFG0
	// and VCFG1 bits are also set to select Vdd and Vss as
	...
	if(num_adc_channels >= 1 && num_adc_channels <= 14)
	{
 	...
 	else if(num_adc_channels == 16)
	{
		ADCON1 = 0; // sixteen channnels
	}
	else
	{
		ADCON1 = 15; // zero channels
	}
...
*
*	CALLED FROM:	vex.c/Interrupt_Handler_Low()
*
*	PARAMETERS:		None
*
*	RETURNS:		Nothing
